...
if __name__ == "__main__":
    ...
    #   默认指向根目录下的VOC数据集
    #-------------------------------------------------------#
    VOCdevkit_path  = 'VOCdevkit/VOC_1'
    ...
    img_out_path = "img_out/detection_1"
    ...
    if miou_mode == 0 or miou_mode == 1:
        ...
        for image_id in tqdm(image_ids):
            ...
            image_iou.save(os.path.join(pred_dir, image_id + ".png"))
            del image_iou
            #infenrence
            ima_det = pspnet.detect_image(image)
            ima_det.save(os.path.join(img_out_path, image_id + ".png"))
